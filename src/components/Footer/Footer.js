  ...
  return (
    <FooterWrapper id="contact">
      <LinkList>
        ...
        <LinkColumn><LinkTitle></LinkTitle><LinkItem></LinkItem></LinkColumn>
        <LinkColumn>
          <LinkTitle>Resume</LinkTitle>
          <LinkItem href="https://drive.google.com/file/d/1AXyf2W_NWTZLiiU9Dz_UQgGoPs7ppGfh/view?usp=sharing" target="_blank">
            Check Out My Resume
          </LinkItem>
        </LinkColumn>
      </LinkList>
